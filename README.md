...
|----|--------|--------|--------|
| 1  | Develop Generative AI Applications: Get Started | 🟡 In progress (~43%) | [`01-generative-ai-get-started/`](./01-generative-ai-get-started/) |
...
_Current status: 3 of 10 courses in progress, 0 completed. Updated 2026-09-08._
